...
public class NivelDos extends World
{
  ...
  public void contarTiempo(){
    ...
    private void prepare(){
        ...
        FondoNivelDos fondo1 = new FondoNivelDos();
        addObject(fondo1, 960, 200);
        FondoNivelDos fondo2 = new FondoNivelDos();
        addObject(fondo2, 2880, 200);

        setPaintOrder(PersonajeRunner.class, Bloque.class, FondoNivelDos.class);
